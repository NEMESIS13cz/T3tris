...
public class OptionsButton extends Button {
	...
	public OptionsButton(float x, float y, float x2, float y2, IMenu m) {
		super(x, y, x2, y2, m);
	}
	...
	public void render(int w, int h) {
		...
		FontMap.drawString(x_ + (x2_ - x_) / 2, y_ + (button_h - scale * 8) / 2, scale, "Options", Constants.BUTTON_TEXT_COLOR, true);
	}
